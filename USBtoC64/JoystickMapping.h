...
#define JM_DPAD_INDEX 12
#define JM_HAS_DPAD_INDEX 1

static const JM_Rule JM_JOY_RULES[] = {
  { 12, 1, JM_EQ, JM_UP },
  { 12, 2, JM_EQ, JM_UP_RIGHT },
  { 12, 3, JM_EQ, JM_RIGHT },
  { 12, 4, JM_EQ, JM_RIGHT_DOWN },
  { 12, 5, JM_EQ, JM_DOWN },
  { 12, 6, JM_EQ, JM_DOWN_LEFT },
  { 12, 7, JM_EQ, JM_LEFT },
  { 12, 8, JM_EQ, JM_LEFT_UP },
  { 10, 1, JM_EQ, JM_FIRE },
  { 10, 2, JM_EQ, JM_UP },
  { 10, 4, JM_EQ, JM_FIRE2 },
  { 10, 8, JM_EQ, JM_FIRE3 },
  { 10, 16, JM_EQ, JM_AUTOFIRE_ON },
  { 10, 32, JM_EQ, JM_AUTOFIRE_ON },
};
...
static const uint8_t JM_MOUSE_X_INDEXES[] = { 0, 4 };
